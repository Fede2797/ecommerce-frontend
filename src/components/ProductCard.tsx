...
export const ProductCard = ({product}: {product: ProductCardType}) => {
  return (
    <article key={product.name} className="group w-[255px] max-h-[230px] shadow-[0px_4px_24px_0px_rgba(123,123,123,0.15)] hover:shadow-[0px_4px_30px_0px_rgba(123,123,123,0.35)] transition-all duration-200 cursor-pointer relative overflow-hidden">
